...
{ 
  ...
  { 
       ...
       String param3 = getParameter("param3");
       if(param2!=null && !param2.equals("null") && param2.length()>0)
       {
    	   parameter2 = Integer.parseInt(param2);
       }
       if(param3!=null && !param3.equals("null") && param3.length()>0)
       {
    	   parameter3 = Integer.parseInt(param3);
       }
