 ...
 * @since mar 3, 2011
 */
public class EmailreferanceSearchUtils
{
	protected static final Log log = LogFactory.getLog(EmailreferanceSearchUtils.class);
	...
	public static String prepareSqlQuery( HttpServletRequest request)
	{
		...
		String projectSqlQuery = " SELECT a.componentId,a.companyemailaddress,a.refdtl,a.emailgroupid" +
				"  FROM emailreferance a";
...
projectSqlQuery += " ORDER BY a.companyemailaddress" ;
	...
	public static ArrayList<String> getColumnHeader()
	{
		...
		columnHeader.add("label.emailreferance.companyEmailAddress");

		columnHeader.add("label.emailreferance.refDtl");

		columnHeader.add("label.emailreferance.emailGroupId");
		/*
		columnHeader.add("label.emailreferance.name");		
		columnHeader.add("label.emailreferance.description"); 
		columnHeader.add("label.emailreferance.last.updatedby");
		 */ 
		return columnHeader;
	}
	...
	{
		String modifyURL = "emailreferanceAction.csmp?method=promptModifyEmailreferance&componentId=";
