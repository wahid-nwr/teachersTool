/*
 * @ (#) CMSModuleCreationException.java
 * 
 ...
 * @since mar 3, 2011
 */
public class ModuleCreationException extends BusinessRuleViolationException
{
    ...
    public ModuleCreationException(int errorCode, String message)
    {
        super(errorCode, message);
        // TODO Auto-generated constructor stub
    }
    public ModuleCreationException(int errorCode)
    {
        super(errorCode);
        // TODO Auto-generated constructor stub
    }
