	...
	try
	{
		...
		for(int i=0;i<vt.size();i++){
			...
			while(rs.next()){
				...
				group_id = rs.getString("EMAIL_GROUP_ID");
		...
		while(rs.next()){
			...
			mess_ownerId = rs.getString("OWNER_ID");
			mess_creat_time = rs.getString("CREATION_TIME");
			mess_refId = rs.getString("REF_ID");
