...
function login() {
	...
	var paramData = "method=login&userId=" + username + "&password=" + password;
	var url = "loginAction.csmp";
	...
	var callback = {
	  success: 	function(o) {
			if(o.responseText !== undefined){
				...
				//alert('o.responseText::'+response);
				if (response != 'ok') {
					//alert('o.responseText::'+response+"fff");
