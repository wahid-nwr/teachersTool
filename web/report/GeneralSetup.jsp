...
com.crystaldecisions.sdk.occa.report.lib.ReportSDKExceptionBase" %><%
	...
	try {
		...
		String reportName = "../GeneralSetup.rpt";
		...
		if (clientDoc == null) {
            ...
            CRJavaHelper.changeDataSource(clientDoc,"../GeneralSetup.rpt","gereralsetup", userName, password, connectString, driverName, JNDIName);
